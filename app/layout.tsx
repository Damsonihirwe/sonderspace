...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en" className={`${anton.variable} ${grotesk.variable} ${mono.variable}`}><body><ThemeProvider><TapeProgress /><Nav />{children}<Footer /></ThemeProvider></body></html>;
}
